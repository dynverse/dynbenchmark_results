...
```{r, results = "asis"}
add_fig(
  result_file("featureimp_cor_distributions.rds", experiment = "02-metric_characterisation/02-individual_metrics"),
...
```{r, results = "asis"}
add_fig(
  result_file("featureimp_wcor_effect.rds", experiment = "02-metric_characterisation/02-individual_metrics"),
...
walkdf(assessments, function(assessment) {
  cat(
    knitr::knit_child(result_file("assessment.Rmd", experiment = "02-metric_characterisation/01-metric_conformity"), quiet=TRUE, envir = environment())
  )
})
```
