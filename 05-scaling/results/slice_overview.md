 ...
 * Number of instances: 10
 * Dataset ids: scaling_0547, scaling_0659, scaling_0660, scaling_0832, scaling_0896, scaling_0907, scaling_1044, scaling_1595, scaling_1727, scaling_2218
 ...
 * Number of instances: 2
 * Dataset ids: scaling_1047, scaling_2320
...
![Cluster plot](error_class_plots/slice_method_error_15.png)

 * Number of instances: 2
 * Dataset ids: scaling_1834, scaling_1991

Last 10 lines of scaling_1834:
```
Performing bootstrap calculation of scEntropy
...
![Cluster plot](error_class_plots/slice_method_error_16.png)

 * Number of instances: 1
 * Dataset ids: scaling_2167

Last 10 lines of scaling_2167:
```
    union
Performing bootstrap calculation of scEntropy
...
![Cluster plot](error_class_plots/slice_method_error_17.png)

 * Number of instances: 1
 * Dataset ids: scaling_2244

Last 10 lines of scaling_2244:
```
    compose, simplify
...
The following object is masked from ‘package:base’:
    union
Performing bootstrap calculation of scEntropy
Iteration:1Error: memory exhausted (limit reached?)
Execution halted
```
...
![Cluster plot](error_class_plots/slice_memory_limit_3.png)

 * Number of instances: 16
 * Dataset ids: scaling_1904, scaling_2014, scaling_2022, scaling_2030, scaling_2038, scaling_2049, scaling_2050, scaling_2080, scaling_2119, scaling_2131, scaling_2171, scaling_2189, scaling_2203, scaling_2205, scaling_2304, scaling_2322
...
![Cluster plot](error_class_plots/slice_memory_limit_4.png)

 * Number of instances: 3
 * Dataset ids: scaling_2243, scaling_2285, scaling_2286

Last 10 lines of scaling_2243:
```
    compose, simplify
The following objects are masked from ‘package:dplyr’:
    as_data_frame, groups, union
...
The following object is masked from ‘package:base’:
    union
Performing bootstrap calculation of scEntropy
Iteration:1Error: cannot allocate vector of size 98 Kb
Execution halted
```
